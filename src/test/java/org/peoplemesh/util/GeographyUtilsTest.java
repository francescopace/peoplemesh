...
class GeographyUtilsTest {
    ...
    void geographyScore_sameContinent_returnsHalf() {
        assertEquals(0.5, GeographyUtils.geographyScore("IT", "DE", WorkMode.HYBRID), 0.001);
    }
    ...
    void mapLocationToCountryCode_isoCodeAndAliases() {
        ...
        assertEquals("GB", GeographyUtils.mapLocationToCountryCode("uk"));
        assertEquals("GB", GeographyUtils.mapLocationToCountryCode("england"));
    }
