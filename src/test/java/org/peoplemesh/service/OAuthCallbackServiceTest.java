...
class OAuthCallbackServiceTest {
    ...
    @Mock GitHubLlmProfileStructuringService gitHubLlmProfileStructuringService;
    ...
    void handleImport_github_delegatesToExchangeGitHubEnriched() {
        ...
        when(gitHubLlmProfileStructuringService.enrichGitHubImport(enriched)).thenReturn(schema);
