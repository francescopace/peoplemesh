...
class ClusteringSchedulerTest {
    ...
    void runClustering_namedClusterWithoutMatch_createsAutoNode() {
        ...
        doNothing().when(spyScheduler).persistNodeInNewTransaction(any(MeshNode.class));
        ...
        verify(spyScheduler).persistNodeInNewTransaction(newNode);
    ...
    void runClustering_namedClusterWithTagMatch_updatesExistingAutoNode() {
        ...
        verify(spyScheduler).persistNodeInNewTransaction(existing);
