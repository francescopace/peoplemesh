...
public record ProfileSchema(
    ...
    public static final int MAX_TOPICS_FREQUENT = 50;
    public static final int MAX_TOPIC_FREQUENT_LENGTH = 200;
    ...
    public record InterestsInfo(
            @JsonProperty("topics_frequent") @Size(max = MAX_TOPICS_FREQUENT) List<@NotNull @Size(max = MAX_TOPIC_FREQUENT_LENGTH) String> topicsFrequent,
