...
public class MatchesService {
    ...
    public List<MeshMatchResult> matchMyProfile(UUID userId, String type, String country) {
        return matchMyProfile(userId, type, country, null, null, null);
    }

    public List<MeshMatchResult> matchMyProfile(UUID userId, String type, String country, Integer limit, Integer offset) {
        return matchMyProfile(userId, type, country, limit, offset, null);
    }

    public List<MeshMatchResult> matchMyProfile(
            UUID userId, String type, String country, Integer limit, Integer offset, SearchOptions tuning) {
        ...
        SearchQuery profileQuery = profileSearchQueryBuilder.buildFromUserNode(myNode, tuning);
    ...
    private MeshMatchResult.MeshMatchBreakdown toMeshBreakdown(SearchMatchBreakdown breakdown) {
        ...
        return new MeshMatchResult.MeshMatchBreakdown(
                ...
                breakdown.niceToHaveBonus(),
                breakdown.languageScore(),
                breakdown.industryScore(),
                ...
                breakdown.matchedNiceToHaveSkills(),
                breakdown.missingMustHaveSkills(),
                breakdown.reasonCodes(),
                breakdown.mustHaveRequested(),
                breakdown.niceToHaveRequested(),
                breakdown.languageRequested(),
                breakdown.industryRequested(),
                breakdown.geographyRequested(),
                breakdown.mustHavePenaltyFactor(),
                breakdown.negativeSkillsPenaltyFactor(),
                breakdown.seniorityScore(),
                breakdown.keywordScore(),
                breakdown.weightEmbedding(),
                breakdown.weightMustHave(),
                breakdown.weightNiceToHave(),
                breakdown.weightLanguage(),
                breakdown.weightIndustry(),
                breakdown.weightGeography(),
                breakdown.weightSeniority(),
                breakdown.weightKeyword()
        );
    }
}
