...
function iconForAction(action) {
  ...
  const ACTION_ICON_MAP = {
    ...
    PROFILE_SELECTIVE_IMPORT: "person",
    CONSENT_GRANTED: "policy",
    CONSENT_REVOKED: "policy",
    DATA_EXPORTED: "download",
    ACCOUNT_DELETED: "delete",
    OAUTH_LOGIN_SUCCESS: "lock",
    OAUTH_LOGIN_FAILED: "lock",
    SEARCH_EXECUTED: "search",
  };
  return ACTION_ICON_MAP[action] || "notifications";
}
