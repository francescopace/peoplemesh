    ...
    <div class="legal-page">
      ...
      <article class="legal-content container">
            ...
            <table class="legal-table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>OAuth subject data, profile fields (name, bio, skills, email, avatar, repository languages and topics) as authorised by the user.</td>
                </tr>
              </tbody>
            </table>
        ...
        <div class="legal-card">
          ...
          <div class="legal-card-body">
            <p>Your data is stored in the EU (AWS eu-south-1). When profile data is sent to OpenAI for embedding generation, CV structuring, or mesh node naming, it may be processed outside the EU under OpenAI&rsquo;s Data Processing Agreement and applicable safeguards (standard contractual clauses).</p>
          </div>
        </div>
        ...
        <div class="legal-card">
          ...
          <div class="legal-card-body">
            <p>For privacy inquiries: <strong>privacy@peoplemesh.org</strong></p>
